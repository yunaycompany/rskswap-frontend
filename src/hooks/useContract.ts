...
import { ERC20_BYTES32_ABI, ERC777_ABI, ERC20_ABI } from '../constants/abis/erc20'
...
export function useErc777TokenContract(tokenAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(tokenAddress, ERC777_ABI, withSignerIfPossible)
}
